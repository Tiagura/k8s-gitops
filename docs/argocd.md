...
| **5** | User Apps           | User Applications (manifests in [`user-apps/*`](../user-apps/)) | All user-facing applications that rely on the underlying infrastructure being available.|
