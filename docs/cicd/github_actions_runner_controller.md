...
| **ARCRunnerContainerOOMKilled**     | Critical     | Triggers when an ARC runner container is OOMKilled.                                       |
| **ARCRunnerHighCPU**                | Warning      | Triggers when an ARC runner container uses more than 90% of its CPU limit for 15 minutes. |
